...
def train_on_data(model, split=True):
    ...
    pos_file = "E:/3d_lung_nodule/pos_samples/trainval_pos.npy"
    neg_file = "E:/3d_lung_nodule/neg_samples/trainval_neg.npy"
    ...
    if split:   #split代表是否分割出val set
        ...
        csv_logger = callbacks.CSVLogger('E:/3d_lung_nodule/model_results/train_32_model_v1.log', append=True)
...
model_32.save("E:/3d_lung_nodule/model_results/train_32_model_v1.h5")
